...
$code = $filesop[1];
$country = $filesop[1];
$airport_desc = $filesop[1];

$sql = mysql_query("INSERT INTO airport (name,code,country,airport_desc) VALUES ('$name','$project','country','airport_desc')");
$c = $c + 1;
}
